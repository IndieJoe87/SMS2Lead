...
const features = [
  {
    title: 'KI-gestützte SMS-Benachrichtigungen',
    description: 'Automatische SMS-Benachrichtigungen bei verpassten Anrufen. Premium-Nutzer profitieren von unserem KI-Assistenten, der Konversionen durch intelligente Kundenkommunikation steigert.',
    icon: (
  ...
  {
    title: 'KI-Webchat für Ihre Website',
    description: 'Integrierter Webchat mit KI-Funktionalität für 24/7 Kundenbetreuung. Steigern Sie Ihre Conversion-Rate durch intelligente Chatbots, die Kundenanfragen sofort beantworten.',
    icon: (
      <svg className="w-10 h-10" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  {
    title: 'Professional & Premium Features',
    description: 'Erweiterte Funktionen wie CRM-Integration, E-Mail-Marketing, Vertriebs-Pipeline und automatisierte Workflows für maximale Effizienz.',
    icon: (
      <svg className="w-10 h-10" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  {
    title: 'Omnichannel Kommunikation',
    description: 'Nahtlose Integration aller Kommunikationskanäle: SMS, E-Mail, Google Business, Facebook Messenger und mehr - alles in einer Plattform.',
    icon: (
      <svg className="w-10 h-10" fill="none" viewBox="0 0 24 24" stroke="currentColor">
